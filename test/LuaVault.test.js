...
contract('LuaVault', ([alice, dev, luaAddr, minter]) => {
    beforeEach(async () => {
    ...
    // it('should fail, send token', async () => {
    //     await expectRevert(
    //         this.vault.send("0x0D3ab14BBaD3D99F4203bd7a11aCB94882050E7e", '1000', { from: "0x0D3ab14BBaD3D99F4203bd7a11aCB94882050E7e" }),
